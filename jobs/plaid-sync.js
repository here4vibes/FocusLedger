...
async function syncOneItem(item) {
  ...
  // Join through plaid_items to find all accounts for this user regardless of
  // which plaid_item_id they're stored under (handles multiple-items-from-reconnects).
