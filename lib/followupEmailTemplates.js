...
function taskReminderTemplate({ name, taskTitle, when }) {
  ...
  <p style="margin-top:32px;color:#6b6b6b;font-size:13px">— FocusLedger<br><a href="https://app.focusledger.net/settings" style="color:#c9a84c">Manage email preferences</a></p>
</div>`,
  };
}
