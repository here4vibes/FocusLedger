...
function buildSystemPrompt(today, tasks) {
  ...
  return [
    ...
    '• create a task or reminder  • reschedule a task  • mark a task done  • draft AND send an email.',
    ...
    'remind or nudge someone about something at a time, create a task with a due date and time. Convert',
    `natural language to real values relative to today (${today}) — e.g. "nudge me to pack tomorrow`,
    'evening" → create a task for tomorrow\'s date with a time like 18:00.',
